...
interface IToggle {
	...
	locked?: boolean;
	excluded?: boolean;
	lockPlayer(e: React.MouseEvent<HTMLInputElement>): void;
	excludePlayer(e: React.MouseEvent<HTMLInputElement>): void;
	clearSelection(e: React.MouseEvent<HTMLButtonElement>): void;
}
